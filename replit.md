...
## Recent Changes
*   **2025-10-24**: **SALES DELIVERY MODAL FREEZE FIX** - Fixed persistent screen freeze issue when clicking "Add Item Manually" button. Root cause was DOM-dependent JavaScript code executing before DOM was fully ready. Wrapped all event listeners and DOM manipulation code inside `DOMContentLoaded` handler with proper null-checks. Modal now opens and remains fully interactive without any freeze. Architect-reviewed and approved.
